...
values ('Nitin','Sharma','Awash Vikash','Kashipur','Uttarakhand',244713,8955869754,'ns@gmail.com'),
...
update AddressBookTable set Type = 'Family' where First_name = 'Nitin' or First_name = 'Lisan';
